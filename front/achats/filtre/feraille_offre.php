...
<!-- MENU SUR LA GAUCHE -->
        <div class="menuleft col-sm-3">
            ...
            <hr color="black">
            <li class="nav-item">
            <hr color="black">  <a class="nav-link" href="feraille_offre.php">Féraille ou Trésor</a><hr color="black">
            </li>
            <li class="nav-item">
                <a class="nav-link" href="musee_offre.php">Bon pour le musée</a><hr color="black">
            </li>
            <li class="nav-item">
                <a class="nav-link" href="vip_offre.php">Accessoire VIP</a><hr color="black">
            </li>
            </ul>
        </div>
        ...
        <div class="dropdown ">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="feraille_enchere.php">Enchères</a>
                <a class="dropdown-item" href="feraille_offre.php">Plus offrand</a>
                <a class="dropdown-item" href="feraille_immediat.php">Achat immédiat</a>
...
<!-- ARTICLES -->
                <?php
                    $query="SELECT * from article WHERE typevente = 'offre' ";
