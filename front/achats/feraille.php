...
<!-- MENU SUR LA GAUCHE -->
        ...
        <div class="dropdown ">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item ddown" href="filtre/feraille_enchere.php">Enchères</a>
                <a class="dropdown-item ddown" href="filtre/feraille_offre.php">Plus offrand</a>
                <a class="dropdown-item ddown" href="filtre/feraille_immediat.php">Achat immédiat</a>
