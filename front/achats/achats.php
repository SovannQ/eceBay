    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: burlywood">
      ...
      <header>
        <div>
            ...
            <a href="#"><h1 class="titre">Achats</h1></a>
        </div>
    </header>
...
<!-- MENU SUR LA GAUCHE -->
        <div class="menuleft col-sm-3">
            ...
            <li class="nav-item selectionne">
                <hr color="black"> <a class="nav-link" href="feraille.html">Féraille ou Trésor</a><hr color="black">
            </li>
            <li class="nav-item">
                <a class="nav-link" href="musee.html">Bon pour le musée</a><hr color="black">
            </li>
            <li class="nav-item">
                <a class="nav-link" href="vip.html">Accessoire VIP</a><hr color="black">
            </li>
            </ul>
        </div>
